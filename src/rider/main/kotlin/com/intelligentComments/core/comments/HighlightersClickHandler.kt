...
class HighlightersClickHandler(private val project: Project) {
  ...
  fun handleClick(
    ...
    if (singleReference is FrontendInvariantReference) {
      val textSegment = object : UniqueEntityImpl(), TextContentSegment {
        override val highlightedText: HighlightedText = singleReference.invariant.description
      ...
      popupManager.showPopupFor(model, editor, relativePoint)
    }
  }
